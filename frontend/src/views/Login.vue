...
<template>
    <div class="max-w-2xl mx-auto">
      <div class="bg-[#d3e1e4] rounded-lg shadow p-6">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                required
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-900 pr-10"
              />
              <button
                type="button"
              ...
              >
                <img 
                  :src="showPassword ? '/src/assets/show.png' : '/src/assets/hide.png'" 
          ...
          <button
            type="submit"
            class="w-full flex text-white justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium bg-[#256C7B] hover:bg-[#194b56] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Login
          </button>
        </form>
